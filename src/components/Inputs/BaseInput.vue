<template>
  <validation-provider :rules="rules" :name="name" v-bind="$attrs" v-slot="{errors, valid, invalid, validated}">
    <div class="form-group">
       ...
       inputGroupClasses
        ...
        <slot v-bind="slotData">
          <input
            ...
            :required="required"
            class="form-control"
            :class="[{'is-valid': valid && validated && successMessage}, {'is-invalid': invalid && validated && errorMessage}, inputClasses]">
        </slot>
      ...
      <slot name="error">
        <div v-if="invalid && validated" class="invalid-feedback" style="display: block;">
          {{ errorMessage }}
        </div>
      </slot>
    </div>
