  ...
  <div class="wrapper m-2">
    ...
    <div class="col-md-12 form-row mt-2 pt-2">
      ...
      <div class="col-md-5 d-flex">
        ...
        >
          <el-option label="Toàn bộ" value="0"></el-option>
          <el-option
    ...
    <el-card class="box-card">
      ...
      <div class="col-md-12 pt-2 tbl">
        <el-table
          ...
          :border="true"
          stripe
          :data="listReports.content"
        >
          <el-table-column label="STT" type="index"></el-table-column>
          <el-table-column label="Tên tuyến"
          prop="c_ten_tuyen"
          ></el-table-column>
  ...
  methods: {
    ...
    findReport(pageNum,pageSize){
      this.isLoadingReport = true;
        ...
        this.$api.report.findWaterUsageReport(this.pageRequest).then(res=>{
    ...
    downloadReport() {
      this.$api.report.recordWaterUsageDownload(this.pageRequest).then((response) => {
        saveAs(
        new Blob([response]),
        "Bao_cao_tong_hop_khach_hang_su_dung_nuoc_" + this.search.startDate + '_' + this.search.endDate + ".xlsx"
        );
      });
    },
    getEmployee() {
